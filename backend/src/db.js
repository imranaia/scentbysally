...
// Full schema for the whole build (see plan) - only users/admin_permissions
// are actively used by the API in Phase 0/1, the rest is created now so
// later phases are pure route/logic work, not migrations.
db.exec(`
  ...
  -- Backs the custom express-session store in middleware/sessionStore.js
